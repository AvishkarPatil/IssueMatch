...
export default function RequestModal({ mentor, isOpen, onClose, onSubmit }: RequestModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      <div className="bg-gray-900 rounded-lg shadow-lg w-full max-w-md border border-gray-700">
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <h3 className="text-lg font-semibold text-gray-100">Request Mentorship</h3>
          <button 
            onClick={onClose}
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            />
            <div>
              <span className="font-medium text-gray-100">{mentor.name}</span>
              {mentor.timezone && (
          ...
          <div className="flex border-b border-gray-700 mb-4">
            <button
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'details' ? 'text-purple-400 border-b-2 border-purple-400' : 'text-gray-400'}`}
              onClick={() => setActiveTab('details')}
            >
              Request Details
            </button>
            <button
              className={`px-4 py-2 text-sm font-medium ${activeTab === 'schedule' ? 'text-purple-400 border-b-2 border-purple-400' : 'text-gray-400'}`}
          ...
          <form onSubmit={handleSubmit}>
            {activeTab === 'details' ? (
              <>
                ...
                <div className="mb-4">
                  <label htmlFor="issueLink" className="block text-sm font-medium text-gray-300 mb-1">
                    <div className="flex items-center gap-1">
              ...
              <>
                ...
                <div className="p-3 bg-gray-800/50 rounded-md border border-gray-700 mb-4">
