    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-100">Mentor Hub</h1>
        </div>
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-gray-900/70 rounded-lg border border-gray-700 p-1 flex gap-1 shadow-lg">
          <button
      ...
      {activeTab === 'find' ? (
        <>
          <div className="bg-purple-900/20 border border-purple-700/30 rounded-lg p-4 mb-8 flex items-start gap-3">
            <BookOpen className="h-5 w-5 text-purple-400 mt-0.5 flex-shrink-0" />
            <div>
              <p className="text-purple-300 font-medium">How Mentorship Works</p>
        ...
        <div className="bg-gray-900/70 rounded-lg shadow-md border border-gray-700 p-8 mb-8 backdrop-blur-sm">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">Become a Mentor</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-medium text-gray-100">Global Impact</h3>
                </div>
              ...
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-medium text-gray-100">Sharpen Your Skills</h3>
                </div>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-medium text-gray-100">Recognition</h3>
                </div>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-lg font-medium text-gray-100">Networking</h3>
                </div>
                <p className="text-gray-400 text-sm">
            ...
            <div className="flex justify-center">
              <Link 
                href="/mentor/apply"
                className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-md transition-colors font-medium flex items-center gap-2"
              >
